...
const list = () => {
  return (
    <div className="flex flex-col w-full md:w-11/12 md:py-4 md:flex-row md:flex-wrap md:gap-x-5 md:gap-y-7 md:mx-auto 2xl:flex 2xl:flex-row 2xl:flex-wrap">
      <div
        className="col-span-1 2xl:w-1/5 md:w-15 sm:col-span-1  h-full flex flex-col md:pb-1 sm:pt-5 sm:pb-5 lg:pt-5 lg:pb-1 xl:pt-5 xl:pb-5 xl:mr-12 2xl:mr-0 md:px-2 lg:px-5 
         shadow-lg rounded-lg border-gray-50 md:my-0 md:mx-auto xl:w-1/4 sm:w-9/12 sm:mx-auto sm:my-0  sm:px-6 xs:px-8 xs:mx-5 xxs:px-8 xxs:mx-5  xxxs:px-8 xxxs:mx-5"
      >
      ...
      <div
        className="h-full 2xl:w-1/5 md:w-15 xxxs:w-4/5 xxxs:h-full xxxs:mx-auto xxs:w-4/5 xxs:h-full xxs:mx-auto xs:mx-auto lg:w-72 w-80 2xl:w-full mt-10 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110
       cursor-pointer md:mt-0 md:h-full lg:mt-0 lg:h-full shadow-lg rounded-lg
       "
      >
        <img
      ...
      <div
        className="h-full md:w-15 xxxs:w-4/5 xxxs:h-full xxxs:mx-auto xxs:w-4/5 xxs:h-full xxs:mx-auto xs:mx-auto lg:w-72 w-80 2xl:w-1/5 mt-10 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110
       cursor-pointer md:mt-0 md:h-full lg:mt-0 lg:h-full shadow-lg rounded-lg
       "
      >
        <img
