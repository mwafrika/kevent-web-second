            ...
            <div className='w-full mx-auto flex flex-col gap-y-8'>
              ...
              <div className='px-8 w-full title-description'>
                ...
                <div className='flex gap-y-2 pt-8 w-3/4 flex-wrap'>
                  ...
                  <div className='flex flex-row gap-x-2 w-1/2'>
                    <span className='font-bold text-xl'>Date du debut :</span>
                    <span className='text-xl'>{start_date}</span>
                  </div>
                  <div className='flex flex-row gap-x-2 w-1/2'>
                    <span className='font-bold text-xl'>Date de Fin :</span>
                    <span className='text-xl'>{end_date}</span>
                  </div>
                </div>
              </div>
            </div>
