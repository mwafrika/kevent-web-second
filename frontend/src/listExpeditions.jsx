  ...
  return (
    <>
      <section className='flex min-h-screen flex-col'>
        <Header />
        <div className='xl:mr-96 lg:mr-36 md:mr-14 xl:float-right xl:pt-10 md:py-5 md:float-right xxxs:mx-auto xxxs:float-none xxxs:py-10 xxs:py-10 xs:py-10 mt-20'>
        ...
        <div className='flex flex-col w-full md:w-11/12 md:py-4 md:flex-row md:flex-wrap md:gap-x-5 md:gap-y-7 md:mx-auto 2xl:flex 2xl:flex-row 2xl:flex-wrap 2xl:gap-14 2xl:mx-auto 2xl:ml-36 2xl:py-10'>
          <div
          ...
          >
            ...
            <div className='2xl:gap-y-10 flex flex-row flex-wrap h-auto md:gap-x-6 md:gap-y-2 lg:gap-y-6 xl:gap-x-12 lg:gap-x-4 xl:gap-y-4 lg:py-5 xl:py-5 sm:py-5 md:py-5 xs:py-5 xs:gap-x-12 xs:gap-y-6  xxs:py-5 xxs:gap-x-12 xxs:gap-y-6  xxxs:py-5 xxxs:gap-x-1 xxxs:gap-y-3 sm:gap-x-12 sm:gap-y-6 py-2 px-2'>
              <input
                type='button'
                value='Tous'
